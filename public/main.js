$(() => {
    ...
    /*
    socket.on('someone_sat_down', (data) => {
    ...
    socket.on('i_sat_down', (data) => {
        if (data.success) {
            ...
            next_bet_button.click(()=>{
                ...
                socket.emit('place_bet', {seatId: s, bet: next_bet_field.val()});
            });
